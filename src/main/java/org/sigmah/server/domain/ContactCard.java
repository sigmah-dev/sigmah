...
@Entity
@Table(name = EntityConstants.CONTACT_CARD_TABLE)
public class ContactCard extends AbstractEntityId<Integer> {
  private static final long serialVersionUID = -9023212395587715263L;

  @Id
  @GeneratedValue(strategy = GenerationType.AUTO)
  @Column(name = EntityConstants.CONTACT_CARD_COLUMN_ID)
  private Integer id;

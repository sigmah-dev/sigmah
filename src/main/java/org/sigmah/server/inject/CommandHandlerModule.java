...
import org.sigmah.server.handler.GetContactByNameOrEmailHandler;
...
import org.sigmah.server.handler.GetContactImportationSchemesHandler;
...
import org.sigmah.server.handler.GetContactRelationshipsInFrameworkHandler;
import org.sigmah.server.handler.GetContactsHandler;
import org.sigmah.server.handler.GetContactsLatestHistoryHandler;
...
public class CommandHandlerModule extends AbstractCommandHandlerModule {
	...
	protected void configureHandlers() {
		...
		bindHandler(GetContactsLatestHistory.class, GetContactsLatestHistoryHandler.class);
		...
		bindHandler(GetContactRelationshipsInFramework.class, GetContactRelationshipsInFrameworkHandler.class);
		bindHandler(GetContactByNameOrEmail.class, GetContactByNameOrEmailHandler.class);
		...
		bindHandler(GetContactImportationSchemes.class, GetContactImportationSchemesHandler.class);

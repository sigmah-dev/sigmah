...
public class ReportingPeriodValidation {
	...
	/**
	 * This function is used to validate a {@link ReportingPeriod}. It verify if the period of the element is not too near
	 * of the limit of the month (in order to avoid timezone issues). If true, it modify the element.
	 * 
	 * @param period

...
public class GetContactByNameOrEmailHandler extends AbstractCommandHandler<GetContactByNameOrEmail, ListResult<ContactDTO>> {
  private final ContactDAO contactDAO;

  @Inject
  public GetContactByNameOrEmailHandler(ContactDAO contactDAO) {

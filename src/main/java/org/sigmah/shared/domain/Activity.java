...
/**
 * After the {@link org.sigmah.shared.domain.UserDatabase}, the activity is the second level of organization in ActivityInfo.
 * Each activity has its set of indicators and attributes.

 * Realized activities takes place at {@link org.sigmah.shared.domain.Site} sites.
 *
 * @author Alex Bertram
 */
@Entity

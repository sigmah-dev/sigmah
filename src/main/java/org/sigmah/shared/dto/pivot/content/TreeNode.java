...
public abstract class TreeNode<T extends TreeNode> implements Serializable {
	 ...
	 * Serial version UID.
	 */
	private static final long serialVersionUID = -8190020538468617662L;
	...
	/**
	 * @return The depth of the subtree starting at this node. (0 if this node has no children, 1 if all of it's children
	...
	/**
	 * Returns a list of descendant nodes at the given depth. Examples:
	 * <ul>
	 ...
	 *          The depth.
	 * @param placeholders
	 *          if true, null values are added to the list when a subtree has no nodes at the given depth
	 * @return The descendants nodes list.
	 */

...
public final class UserDatabaseDTO extends AbstractModelDataEntityDTO<Integer> {
	...
	/**
	 * Sets the permission of the current user to view all partner's data in this UserDatabase. See
	 * {@link org.sigmah.server.domain.UserPermission#setAllowViewAll(boolean)}
	 */
	...
	/**
	 * @return true if the client receiving the DTO is authorized to view data from all partners in this UserDatabase. See
	 *         {@link org.sigmah.server.domain.UserPermission#setAllowViewAll(boolean)}
	 */
	...
	/**
	 * Sets the permission of the current user to edit data on behalf of the Partner in this UserDatabase to which the
	...
	/**
	 * @return true if the client receiving the DTO is authorized to edit data for their Partner in this UserDatabase
	 */
	...
	/**
	 * @return true if the client receiving the DTO is authorized to design (change indicators, etc) this UserDatabase
	 */
	...
	/**
	 * Sets the permission of the current user to edit data in this UserDatabase on behalf of all partners.
	 */
	...
	/**
	 * @return true if the client receiving the DTO is authorized to edit data for all Partners in this UserDatabase
	 */
	...
	/**
	 * @return true if current user is allowed to make changes to user permissions on behalf of the Partner to which they
	 *         belong
	 */
	...
	/**
	 * Sets the permission of the current user to make changes to user permissions on behalf of the Partner to which they
	 * belong in this UserDatabase.
	 */
	...
	/**
	 * @return true if the current user is allowed to make changes to user permissions on behalf of all Partners in this
	 *         UserDatabase
	 */
	...
	/**
	 * Sets the permission of the current user to modify user permissions for this UserDatabase on behalf of all Partners

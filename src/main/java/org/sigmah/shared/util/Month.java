...
public class Month implements Serializable, Comparable<Month> {
	 ...
	 * Serial version UID.
	 */
	private static final long serialVersionUID = -8850584104362115311L;
	...
	/**
	 * Constructs a <code>Month</code> at the given month and year. If month is outside of the range 1..12, the values are
	 * normalized. For example, <code>Month(2001, 13)</code> initalizes this <code>Month</code> to January, 2002.
	 *
	 * @param year
	 ...
	 *
	 * @param m
	 *          The <code>Month</code> with which to compare this <code>Month</code>
	 * @return 0 if this month is the same as <code>m</code>, -1 if this month is earlier than <code>m</code>, or +1 if
	 *         this month follows <code>m</code>
	 */
	@Override
	...
	/**
	 * Parses a string in the format 2009-1, 2009-03, 2009-12 and returns the value as a <code>Month</code>
	 *
	 * @param s

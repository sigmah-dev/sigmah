...
/**
 * Provides layout groups admin grid columns configuration.
 *
...
abstract class LayoutGroupColumnsProvider {
     ...
     *
     * @return <code>true</code> if the parent model is editable,
    ...
    public ColumnModel getColumnModel() {
        ...
        // Group Name column.
        // --
        ColumnConfig column = new ColumnConfig(LayoutGroupDTO.TITLE, I18N.CONSTANTS.adminFlexibleName(), 180);
        ...
        // Containers column.
        // --
        column = new ColumnConfig(LayoutGroupDTO.CONTAINER, I18N.CONSTANTS.adminFlexibleContainer(), 150);
        column.setRenderer(new GridCellRenderer<LayoutGroupDTO>() {
        ...
        column = new ColumnConfig("position", I18N.CONSTANTS.adminGroupsPosition(), 70);
        column.setRenderer(new GridCellRenderer<LayoutGroupDTO>() {

...
@Singleton
public class AddImprortationSchemeView extends AbstractPopupView<PopupWidget> implements AddImprortationSchemePresenter.View {
	...
	public AddImprortationSchemeView() {

...
public class ExportContactsSettingView extends AbstractPopupView<PopupWidget> implements ExportContactsSettingPresenter.View {
	...
	private ListStore<ContactModelDTO> modelsStore;
	...
	public ExportContactsSettingView() {
		...
		modelsStore = new ListStore<ContactModelDTO>();
	...
	public void initialize() {
		...
		// configure fields
		// contact model
		Grid<ContactModelDTO> pModelsGrid = getModelsGrid();
		// flex elements
	...
	private Grid<ContactModelDTO> getModelsGrid() {
		...
		column.setRenderer(new GridCellRenderer<ContactModelDTO>() {
			...
			@Override
			public Object render(final ContactModelDTO model, String property, ColumnData config, int rowIndex, int colIndex, ListStore<ContactModelDTO> store,
					Grid<ContactModelDTO> grid) {
		...
		Grid<ContactModelDTO> grid = new Grid<ContactModelDTO>(modelsStore, cm);
	...
	private Grid<FlexibleElementDTO> getElementsGrid() {
		...
		column.setRenderer(new GridCellRenderer<FlexibleElementDTO>() {
			...
			public Object render(FlexibleElementDTO model, String property, ColumnData config, int rowIndex, int colIndex, ListStore<FlexibleElementDTO> store,
					Grid<FlexibleElementDTO> grid) {
				String title = null;
				if (ElementTypeEnum.DEFAULT_CONTACT.equals(model.getElementType())) {
					title = DefaultContactFlexibleElementType.getName(((DefaultContactFlexibleElementDTO) model).getType());
				} else {
	...
	@Override
	public ListStore<ContactModelDTO> getModelsStore() {
		return modelsStore;
	}

...
/**
 * Model's layout groups administration presenter.
 * 
...
public class LayoutGroupAdminPresenter<E extends IsModel> extends
    ...
    public void onBind() {
        ...
        view.getDeleteButton().addSelectionListener(new SelectionListener<ButtonEvent>() {
            ...
            public void componentSelected(final ButtonEvent event) {
                onGroupsDeleteAction(view.getGrid().getSelectionModel().getSelection());
            }
        });

        // On groups creation/update event.
        registerHandler(eventBus.addHandler(UpdateEvent.getType(), new UpdateHandler() {
            ...
            public void onUpdate(final UpdateEvent event) {
                ...
                if (event.concern(UpdateEvent.LAYOUT_GROUP_UPDATE)) {
                    ...
                    final LayoutGroupDTO updatedOrCreatedElement = event.getParam(2);
    ...
    public void loadTab(final E model) {
        ...
        view.getStore().add(model.getAllGroups());
     ...
     *
     * @param groups The selected group to delete.
     */
    ...
    private void onGroupsDeleteAction(final List<LayoutGroupDTO> selection) {
        ...
        if (ClientUtils.isEmpty(selection)) {
            N10N.warn(I18N.CONSTANTS.delete(), I18N.MESSAGES.adminGroupsDeleteNone());
            return;
        }
        ...
        N10N.confirmation(I18N.CONSTANTS.delete(), I18N.CONSTANTS.adminGroupsConfirmDelete(), elementNames, new ConfirmCallback() {
            ...
            public void onAction() {
                ...
                dispatch.execute(new DeleteGroups(selection), new CommandResultHandler<VoidResult>() {
                    ...
                    public void onCommandSuccess(final VoidResult result) {
                        ...
                        // Notification.
                        N10N.infoNotif(I18N.CONSTANTS.infoConfirmation(), I18N.CONSTANTS.adminDeleteLayoutGroupsConfirm());

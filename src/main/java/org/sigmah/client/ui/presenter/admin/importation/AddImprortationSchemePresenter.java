...
import org.sigmah.client.ui.view.admin.importation.AddImprortationSchemeView;
...
@Singleton
public class AddImprortationSchemePresenter extends AbstractPagePresenter<AddImprortationSchemePresenter.View> {
	...
	@ImplementedBy(AddImprortationSchemeView.class)
	...
	@Inject
	protected AddImprortationSchemePresenter(View view, Injector injector) {
		super(view, injector);
	}
			...
			public void handleEvent(BaseEvent be) {
				...
				dispatch.execute(cmd, new CommandResultHandler<CreateResult>() {
					...
					protected void onCommandSuccess(CreateResult result) {
						...
						eventBus.fireEvent(new UpdateEvent(UpdateEvent.UPDATE_LISTE_IMPORTATION_SCHEME));

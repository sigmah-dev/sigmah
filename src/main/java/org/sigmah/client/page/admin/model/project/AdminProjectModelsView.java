...
public class AdminProjectModelsView extends View {
    ...
    private Grid<ProjectModelDTOLight> buildModelsListGrid() {
        ...
        column.setRenderer(new GridCellRenderer<ProjectModelDTOLight>() {
            ...
            @Override
            public Object render(final ProjectModelDTOLight model, String property, ColumnData config, int rowIndex,
                    int colIndex, ListStore<ProjectModelDTOLight> store, Grid<ProjectModelDTOLight> grid) {

                final AdminPageState derivation =
                        new AdminPageState(AdminProjectModelsView.this.currentState.getCurrentSection());
        ...
        column.setRenderer(new GridCellRenderer<ProjectModelDTOLight>() {
            ...
            @Override
            public Object render(ProjectModelDTOLight model, String property, ColumnData config, int rowIndex,
                    int colIndex, ListStore<ProjectModelDTOLight> store, Grid<ProjectModelDTOLight> grid) {
        ...
        column.setRenderer(new GridCellRenderer<ProjectModelDTOLight>() {
            ...
            @Override
            public Object render(final ProjectModelDTOLight model, final String property, ColumnData config,
                    int rowIndex, int colIndex, ListStore<ProjectModelDTOLight> store, Grid<ProjectModelDTOLight> grid) {

                Button buttonDelete = new Button(I18N.CONSTANTS.delete());
                buttonDelete.setItemId(UIActions.deleteModel);
                buttonDelete.disable();
                buttonDelete.addListener(Events.OnClick, new Listener<ButtonEvent>() {

                    @Override
                    public void handleEvent(ButtonEvent be) {
                        AdminModelActionListener listener =
                                new AdminModelActionListener(AdminProjectModelsView.this, dispatcher, true);

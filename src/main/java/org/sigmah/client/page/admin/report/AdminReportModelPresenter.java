...
public class AdminReportModelPresenter implements AdminModelSubPresenter {
    ...
    public boolean isProjectReportModelUpdated() {
        return projectReportModelUpdated;
    }

    public void setProjectReportModelUpdated(boolean projectModelUpdated) {
        this.projectReportModelUpdated = projectModelUpdated;
    }
    ...
    private void addListeners() {
        ...
        view.getAddReportButton().addListener(Events.OnClick, new Listener<ButtonEvent>() {
            ...
            public void handleEvent(ButtonEvent be) {
                ...
                if (view.getReportName().getValue() != null
                    ...
                    // RPC
                    dispatcher.execute(new CreateEntity("ProjectReportModel", newReportProperties), null,
                        new AsyncCallback<CreateResult>() {
                            ...
                            public void onFailure(Throwable caught) {
                                ...
                                // RPC failed
                                MessageBox.alert(
                                    I18N.CONSTANTS.adminReportModelCreationBox(),
                                    I18N.MESSAGES.adminStandardCreationFailure(I18N.CONSTANTS
                                        .adminReportModelStandard() + " '" + view.getReportName().getValue() + "'"),
                                    null);
                            ...
                            public void onSuccess(CreateResult result) {
                                ...
                                if (result != null) {
                                    ...
                                    Notification.show(
                                        I18N.CONSTANTS.adminReportModelCreationBox(),
                                        I18N.MESSAGES.adminStandardUpdateSuccess(I18N.CONSTANTS
                                            .adminReportModelStandard() + " '" + result.getEntity().get("name") + "'"));
                                    ...
                                    MessageBox.alert(
                                        I18N.CONSTANTS.adminReportModelCreationBox(),
                                        I18N.MESSAGES.adminStandardCreationNull(I18N.CONSTANTS
                                            .adminReportModelStandard() + " '" + view.getReportName().getValue() + "'"),
                                        null);
                                }
                    ...
                    MessageBox.alert(I18N.CONSTANTS.adminReportModelCreationBox(),
                        I18N.CONSTANTS.adminStandardInvalidValues(), null);
                    view.getSectionsToBeSaved().clear();
                }
            }
        });
        ...
        view.getSaveReportSectionButton().addListener(Events.OnClick, new Listener<ButtonEvent>() {
            ...
            public void handleEvent(ButtonEvent be) {
                ...
                projectReportModelUpdated = false;
                ...
                UpdateProjectReportModel updateCommand =
                        new UpdateProjectReportModel(view.getCurrentReportModel().getId(), changes);

                // RPC to save changes
                dispatcher.execute(updateCommand,
                    new MaskingAsyncMonitor(view.getSectionsGrid(), I18N.CONSTANTS.saving()),
                    new AsyncCallback<ProjectReportModelResult>() {
                        ...
                        @Override
                        public void onSuccess(ProjectReportModelResult result) {
        ...
        view.getSectionsGrid().addListener(Events.AfterEdit, new Listener<GridEvent<ProjectReportModelSectionDTO>>() {
            ...
            public void handleEvent(GridEvent<ProjectReportModelSectionDTO> be) {
                ...
                if (sectionToBeSaved != null) {
                    ...
                    projectReportModelUpdated = true;
                    ...
                    else if (sectionToBeSaved.getParentSectionModelName().equals(
                    ...
                    // When users have edited the parent selections fields and select non-root section's name
                    else if (view.getParentSectionsCombo().getSelection() != null
                        && view.getParentSectionsCombo().getSelection().size() > 0) {
                        ...
                        ProjectReportModelSectionDTO parentSection =
                                view.getParentSectionsCombo().getSelection().get(0);
    ...
    private void recursiveFillSectionsList(ProjectReportModelSectionDTO rootSection) {
        ...
        for (final ProjectReportModelSectionDTO child : setCompositeNames(rootSection.getSubSectionsDTO())) {
    ...
    public static void refreshReportModelsPanel(Dispatcher dispatcher, final View view) {
        dispatcher.execute(new GetReportModels(), view.getReportModelsLoadingMonitor(),

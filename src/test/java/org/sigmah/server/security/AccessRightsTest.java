...
public class AccessRightsTest {
	...
	public void testContainsPermissions() {
		...
		permissions.add(GlobalPermissionEnum.EDIT_ALL_PROJECTS);
		...
		Assert.assertTrue(CollectionUtils.containsAll(permissions, set(GlobalPermissionEnum.EDIT_ALL_PROJECTS)));
		Assert.assertTrue(CollectionUtils.containsAll(permissions, set(GlobalPermissionEnum.CREATE_PROJECT, GlobalPermissionEnum.EDIT_ALL_PROJECTS)));

		Assert.assertFalse(CollectionUtils.containsAll(permissions,
			set(GlobalPermissionEnum.CREATE_PROJECT, GlobalPermissionEnum.EDIT_ALL_PROJECTS, GlobalPermissionEnum.DELETE_PROJECT)));

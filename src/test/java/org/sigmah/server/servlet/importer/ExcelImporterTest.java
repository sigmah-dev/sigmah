 ...
 * Sigmah
 * %%
 * Copyright (C) 2010 - 2018 Groupe URD
 * %%
 ...
 */
public class ExcelImporterTest extends AbstractDaoTest {
	...
	public void testGetCorrespondances() throws CommandException, IOException {
		...
		importer.setInputStream(getClass().getResourceAsStream("import.xlsx"));
		
		final List<ImportDetails> correspondances = importer.getCorrespondances();
		Assert.assertNotNull(correspondances);
		Assert.assertEquals(3, correspondances.size());

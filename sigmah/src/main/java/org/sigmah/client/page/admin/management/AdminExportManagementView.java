...
public class AdminExportManagementView extends ContentPanel implements View {
    ...
    static class SimpleComboBoxData extends BaseModelData {
        private static final long serialVersionUID = 8817471762585152190L;
    ...
    private final ComboBox<SimpleComboBoxData> exportSchedulesBox;
    private final ComboBox<SimpleComboBoxData> deleteSchedulesBox;
    private final Button saveButton;
    private final Grid<ProjectModelDTO> pModelsGrid;
    private final Grid<FlexibleElementDTO> elementsGrid;
    ...
    public AdminExportManagementView() {
        ...
        // configure fields
        // project model
        pModelsGrid = getModelsGrid();
        // flex elements
        elementsGrid = getElementsGrid();
    ...
    @Override
    public ListStore<ProjectModelDTO> getModelStore() {
        return modelsStore;
    }

    @Override
    public Map<Integer, SimpleComboBoxData> getExportScheduleMap() {
        return exportScheduleMap;
    }

    @Override
    public Map<Integer, SimpleComboBoxData> getDeleteScheduleMap() {
        return deleteScheduleMap;
    }
    ...
    @Override
    public Grid<FlexibleElementDTO> getFlexibleElementGrid() {
        return elementsGrid;
    }

...
public class AttachFileHandler implements AttachMenuBuilder.AttachDocumentHandler {
    ...
    public Dialog getDialog(final ListStore<ReportReference> documentsStore,
            final OrgUnitDTO orgUnit, final FlexibleElementDTO flexibleElement, final MenuItem menuItem,
	...
	@Override
	public boolean shouldEnableMenuItem(MenuItem menuItem,
			int containerId, LocalizedElement element, Dispatcher dispatcher) {
		return true;
	}

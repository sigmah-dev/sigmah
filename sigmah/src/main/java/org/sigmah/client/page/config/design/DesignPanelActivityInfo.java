...
public class DesignPanelActivityInfo extends DesignPanelBase implements Page {
    ...
    protected void initNewMenu(Menu menu, SelectionListener<MenuEvent> listener) {
        ...
        final MenuItem newAttributeGroup =
                new MenuItem(I18N.CONSTANTS.newAttributeGroup(), IconImageBundle.ICONS.attributeGroup(), listener);
        newAttributeGroup.setItemId("AttributeGroup");
        menu.add(newAttributeGroup);

        final MenuItem newAttribute =
                new MenuItem(I18N.CONSTANTS.newAttribute(), IconImageBundle.ICONS.attribute(), listener);
        newAttribute.setItemId("Attribute");
        menu.add(newAttribute);

        final MenuItem newIndicator =
                new MenuItem(I18N.CONSTANTS.newIndicator(), IconImageBundle.ICONS.indicator(), listener);
    ...
    protected void doLoad() {
        for (ActivityDTO activity : db.getActivities()) {
            ...
            AttributeGroupFolder attributeFolder = new AttributeGroupFolder(activityNode, I18N.CONSTANTS.attributes());
            ...
            IndicatorFolder indicatorFolder = new IndicatorFolder(activityNode, I18N.CONSTANTS.indicators());

...
public class DataEntryPage extends LayoutContainer implements Page {
    ...
    @Inject
    public DataEntryPage(EventBus eventBus, ActivityFilterPanel activityPanel, AdminFilterPanel adminPanel, DateRangePanel datePanel, PartnerFilterPanel partnerPanel, SiteGridPanel gridPanel, SiteMap siteMap, SiteDetailPanel detailPanel) {
    ...
    private void showEasternComponent(final Component component, final ToggleButton sideBarButton) {

...
public class ProjectIndicatorsPresenter implements SubPresenter{
	...
	public ProjectIndicatorsPresenter(Dispatcher dispatcher, EventBus eventBus, ProjectPresenter projectPresenter) {
	...
	public Component getView() {
		if (view == null) {
			...
			this.designPresenter = new DesignPresenter(eventBus, service, I18N.CONSTANTS, new DesignView(service) , projectPresenter, treeStore);

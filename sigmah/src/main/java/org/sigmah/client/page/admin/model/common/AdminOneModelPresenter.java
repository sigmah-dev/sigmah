                ...
                new Listener<MessageBoxEvent>() {
                    ...
                    public void handleEvent(MessageBoxEvent be) {
                        if (Dialog.NO.equals(be.getButtonClicked().getItemId())) {
                            ...
                            cmdGetProjectsByModel.setProjectModelId(new Long((long) view.getCurrentProjectModel()
                                    .getId()));
                            ...
                            dispatcher.execute(cmdGetProjectsByModel, new MaskingAsyncMonitor(view.getTopPanel(),
                                ...
                                public void onSuccess(ProjectListResult result) {
                                    ...
                                    if (result != null && testProjects != null && testProjects.size() > 0) {
                                        ...
                                        String waringMessage = I18N.MESSAGES.DraftProjectModelChangeStatusDetails(
                                                testProjectNames, ProjectModelStatus.getName(targetStatus));
                        ...
                        public void onFailure(Throwable caught) {
                            MessageBox.alert(
                                    ...
                                    I18N.MESSAGES.adminStandardCreationFailure(I18N.CONSTANTS
                                            .adminProjectModelStandard() + " '" + view.getNameField().getValue() + "'"),
                                    null);
                        }
                        ...
                        public void onSuccess(CreateResult result) {
                            if (result != null && result.getEntity() != null) {
                                ...
                                Notification.show(I18N.CONSTANTS.adminProjectModelUpdateBox(), I18N.MESSAGES
                                        .adminStandardUpdateSuccess(I18N.CONSTANTS.adminProjectModelStandard() + " '"
                                ...
                                eventBus.fireEvent(new NavigationEvent(NavigationHandler.NavigationRequested,
                                        currentState.deriveTo(currentState.getCurrentSection(),
                                                currentState.getModel(), MAIN_TABS[tabIndex], true)));

                            } else {

                                MessageBox.alert(I18N.CONSTANTS.adminProjectModelUpdateBox(), I18N.MESSAGES
                                        .adminStandardCreationNull(I18N.CONSTANTS.adminProjectModelStandard() + " '"
                    ...
                    new AsyncCallback<CreateResult>() {
                        ...
                        public void onFailure(Throwable caught) {
                            MessageBox.alert(I18N.CONSTANTS.adminOrgUnitsModelCreationBox(), I18N.MESSAGES
                                    .adminStandardCreationFailure(I18N.CONSTANTS.adminOrgUnitsModelStandard() + " '"
                                            + view.getNameField().getValue() + "'"), null);
                        }
                        ...
                        public void onSuccess(CreateResult result) {
                            if (result != null && result.getEntity() != null) {
                                ...
                                Notification.show(I18N.CONSTANTS.adminOrgUnitsModelCreationBox(), I18N.MESSAGES
                                        .adminStandardUpdateSuccess(I18N.CONSTANTS.adminOrgUnitsModelStandard() + " '"
                                                + view.getNameField().getValue() + "'"));
                                ...
                                eventBus.fireEvent(new NavigationEvent(NavigationHandler.NavigationRequested,
                                        currentState.deriveTo(currentState.getCurrentSection(),
                                                currentState.getModel(), MAIN_TABS[tabIndex], false)));

                            } else {
                                MessageBox.alert(I18N.CONSTANTS.adminOrgUnitsModelCreationBox(), I18N.MESSAGES
                                        .adminStandardCreationNull(I18N.CONSTANTS.adminOrgUnitsModelStandard() + " '"
                                                + view.getNameField().getValue() + "'"), null);
                            }
                        }
                    });

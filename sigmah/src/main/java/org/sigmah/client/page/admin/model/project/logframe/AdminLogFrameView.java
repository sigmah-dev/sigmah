...
public class AdminLogFrameView extends View {
    ...
    public AdminLogFrameView(Dispatcher dispatcher, ProjectModelDTO model) {
        ...
        objectives_enable_groups.addListener(Events.Change, listener);
        ...
        objectives_max_groups.addListener(Events.Change, listener);
        ...
        activities_max.addListener(Events.Change, listener);
        ...
        activities_enable_groups.addListener(Events.Change, listener);
        ...
        activities_max_groups.addListener(Events.Change, listener);
        ...
        activities_max_per_group.addListener(Events.Change, listener);
        ...
        results_max.addListener(Events.Change, listener);
        ...
        results_enable_groups.addListener(Events.Change, listener);
        ...
        results_max_groups.addListener(Events.Change, listener);
        ...
        results_max_per_group.addListener(Events.Change, listener);
        ...
        results_max_per_obj.addListener(Events.Change, listener);
        ...
        prerequisites_max.addListener(Events.Change, listener);
        ...
        prerequisites_enable_groups.addListener(Events.Change, listener);
        ...
        prerequisites_max_groups.addListener(Events.Change, listener);
        ...
        prerequisites_max_per_group.addListener(Events.Change, listener);
    ...
    private void updateLogFrame() {
        ...
        if (objectives_max_per_group.getValue() != null)
            logFrameProperties.put(AdminUtil.PROP_OBJ_MAX_PER_GROUP, translateMaxValue(objectives_max_per_group
                .getValue().getValue()));
        ...
        if (objectives_max_groups.getValue() != null)
            logFrameProperties.put(AdminUtil.PROP_OBJ_MAX_GROUPS, translateMaxValue(objectives_max_groups.getValue()
                .getValue()));
        ...
        if (activities_max_per_result.getValue() != null)
            logFrameProperties.put(AdminUtil.PROP_A_MAX_PER_RESULT, translateMaxValue(activities_max_per_result
                .getValue().getValue()));
        if (activities_max_groups.getValue() != null)
            logFrameProperties.put(AdminUtil.PROP_A_MAX_GROUPS, translateMaxValue(activities_max_groups.getValue()
                .getValue()));
        if (activities_max_per_group.getValue() != null)
            logFrameProperties.put(AdminUtil.PROP_A_MAX_PER_GROUP, translateMaxValue(activities_max_per_group
                .getValue().getValue()));
        ...
        if (results_max_per_obj.getValue() != null)
            logFrameProperties.put(AdminUtil.PROP_R_MAX_PER_OBJ, translateMaxValue(results_max_per_obj.getValue()
                .getValue()));
        if (results_max_groups.getValue() != null)
            logFrameProperties.put(AdminUtil.PROP_R_MAX_GROUPS, translateMaxValue(results_max_groups.getValue()
                .getValue()));
        if (results_max_per_group.getValue() != null)
            logFrameProperties.put(AdminUtil.PROP_R_MAX_PER_GROUP, translateMaxValue(results_max_per_group.getValue()
                .getValue()));
        ...
        if (prerequisites_max_groups.getValue() != null)
            logFrameProperties.put(AdminUtil.PROP_P_MAX_GROUPS, translateMaxValue(prerequisites_max_groups.getValue()
                .getValue()));
        if (prerequisites_max_per_group.getValue() != null)
            logFrameProperties.put(AdminUtil.PROP_P_MAX_PER_GROUP, translateMaxValue(prerequisites_max_per_group
                .getValue().getValue()));
            ...
            new AsyncCallback<CreateResult>() {
                ...
                public void onSuccess(CreateResult result) {
                    if (result != null && result.getEntity() != null)
                        Notification.show(I18N.CONSTANTS.adminLogFrameUpdate(),
                            I18N.MESSAGES.adminLogFrameUpdateSuccess());
                    else
                        MessageBox.alert(I18N.CONSTANTS.adminLogFrameUpdate(),
                            I18N.MESSAGES.adminLogFrameUpdateFailure(), null);
                }
            });

 ...
 * @author sherzod
 */
public abstract class BaseSynthesisExcelTemplate 
	...
	public BaseSynthesisExcelTemplate(final BaseSynthesisData data,
	...
	private void putElement(HSSFSheet sheet,int rowIndex,ValueLabel pair,boolean isMessage){
    	...
    	int lineCount = Math.max(pair.getLines(),
    			utils.calculateLineCount(pair.getFormattedLabel(), labelColWidth));   
